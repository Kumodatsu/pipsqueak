...
TEST(TestVec4, vectors_with_equal_components_are_equal) {
  const Vec4 vec_a(1.0f, 2.0f, 3.0f, 4.0f);
  const Vec4 vec_b(1.0f, 2.0f, 3.0f, 4.0f);
  EXPECT_TRUE(vec_a == vec_b);
}

TEST(TestVec4, vectors_with_unequal_components_are_not_equal) {
  const Vec4 vec_a(1.0f, 2.0f, 3.0f, 4.0f);
  const Vec4 vec_b(2.0f, 2.0f, 3.0f, 4.0f);
  EXPECT_FALSE(vec_a == vec_b);
}

TEST(TestVec4, vectors_with_equal_components_are_not_unequal) {
  const Vec4 vec_a(1.0f, 2.0f, 3.0f, 4.0f);
  const Vec4 vec_b(1.0f, 2.0f, 3.0f, 4.0f);
  EXPECT_FALSE(vec_a != vec_b);
}

TEST(TestVec4, vectors_with_unequal_components_are_unequal) {
  const Vec4 vec_a(1.0f, 2.0f, 3.0f, 4.0f);
  const Vec4 vec_b(2.0f, 2.0f, 3.0f, 4.0f);
  EXPECT_TRUE(vec_a != vec_b);
}
...
TEST(TestVec4, zero_creates_vector_with_all_elements_zero) {
